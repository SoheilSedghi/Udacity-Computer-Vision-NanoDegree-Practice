...
x_cells = gray.shape[1] // cell_size[1]
y_cells = gray.shape[0] // cell_size[0]

# Distance between blocks in units of Cell Size
h_stride = 1 
v_stride = 1

# Block Stride in pixels (horizantal, vertical)
block_stride = (h_stride * cell_size[1],
                v_stride * cell_size[0])
...
print('\nThe gray scale image has shape: ', gray.shape)
print()
